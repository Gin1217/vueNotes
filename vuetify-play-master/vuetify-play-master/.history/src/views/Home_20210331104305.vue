<template>
  <v-app>
    ...
    >
      ...
      <v-toolbar-title>安安安安安懿</v-toolbar-title>
      ...
      <div class="mt-1">
        <v-avatar>
          <v-img src="https://i.loli.net/2021/03/12/7RXdxO9CiIWf5My.jpg"></v-img>
        </v-avatar>
        <v-btn icon>
...
export default {
  ...
  data: () => ({
    ...
    show: false,
    mini: false,
    imgs: ['1.jpg', '2.jpg', '3.jpg', '4.jpg', '5.jpg', 'https://i.loli.net/2021/03/12/7RXdxO9CiIWf5My.jpg']
  }),
  created() {
